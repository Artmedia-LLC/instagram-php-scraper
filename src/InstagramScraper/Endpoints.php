...
class Endpoints
{
    ...
    const MEDIA_JSON_BY_TAG = 'https://www.instagram.com/explore/tags/{tag}/';
    ...
    public static function getMediasJsonByTagLink($tag)
    {
        return str_replace('{tag}', urlencode($tag), static::MEDIA_JSON_BY_TAG);
    }
